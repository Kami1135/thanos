...
func TestBestEffortCleanAbortedPartialUploads(t *testing.T) {
	...
	BestEffortCleanAbortedPartialUploads(ctx, logger, partial, bkt, deleteAttempts, blockCleanupFailures)
	testutil.Equals(t, 1.0, promtest.ToFloat64(deleteAttempts))
	testutil.Equals(t, 1.0, promtest.ToFloat64(blockCleanupFailures))
